...
<title>编辑员工 - 员工管理 - H-ui.admin v2.4</title>
</head>
<body>
	...
	<form class="form form-horizontal" id="smart-form">
	    <div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo ($staff["sno"]); ?>" placeholder="" id="name" name="name" disabled="true">
				</div>
		</div>
		<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>姓名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo ($staff["name"]); ?>" placeholder="" id="name" name="name">
				</div>
		</div>
		<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9 skin-minimal">
					<div class="radio-box">
						<input name="sex" value="0" type="radio" id="sex-1" <?php if($staff["sex"] == 0 ): ?>checked="checked"<?php endif; ?> >
						<label for="sex-1">男</label>
					</div>
					<div class="radio-box">
						<input type="radio" value="1" id="sex-2" name="sex" <?php if($staff["sex"] == 1 ): ?>checked="checked"<?php endif; ?> >
		...
		<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo ($staff["telephone"]); ?>" placeholder="" id="telephone" name="telephone">
				</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo ($staff["position"]); ?>" placeholder="" id="position" name="position">
				</div>
		</div>
