...
<title>编辑家庭 - 家庭管理 - H-ui.admin v2.4</title>
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal" id="smart-form">
		<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>家庭名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo ($Family["name"]); ?>" placeholder="" id="name" name="name">
				</div>
		</div>
		<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>家庭电话：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo ($Family["telephone"]); ?>" placeholder="" id="telephone" name="telephone">
				</div>
		</div>
		<input type="hidden" name="depart_id" value="<?php echo ($Family["depart_id"]); ?>"/>
		<div class="row cl">
...
<script type="text/javascript">
 var SCOPE = {
        'save_url' : './admin.php?c=Family&a=add',
