...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>开门记录 <span class="c-gray en">&gt;</span>开门记录 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
		...
		<tbody>
		 <?php if(is_array($Opendoors)): $i = 0; $__LIST__ = $Opendoors;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				<td><input type="checkbox" value="<?php echo ($vo["Opendoor_id"]); ?>" name="listorder[<?php echo ($vo["Opendoor_id"]); ?>]"></td>
				...
				<td>
		          <a title="删除" attr-id="<?php echo ($vo["Opendoor_id"]); ?>" id="smart-delete" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
<script type="text/javascript">
 ...
 var SCOPE = {
        'jump_url' : './admin.php?c=Opendoor&a=index',
        'set_online_url':'./admin.php?c=Opendoor&a=setonline',
        'listorder_url' : './admin.php?c=Opendoor&a=listorder',
    }
</script>
